...
ActiveRecord::Schema.define(version: 2020_08_20_054636) do
  ...
  create_table "hashtag_users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
